            ...
            <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td style="padding: 0px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                        ...
                        <p class="lead">Er is een offerte goedgekeurd. Hieronder de gegevens</p>
                        <p>
                            ...
                            <strong>Datum goedkeuring:</strong> <?= date('d-m-Y'); ?><br /><br />

                            <strong>Gebruiker:</strong> <?= $userName ?><br />
                            <strong>Email:</strong> <?= $userEmail ?><br />
                            <strong>Telefoonnummer:</strong> <?= $userTel ?>
                        </p>
