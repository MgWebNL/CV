 ...
 */
define ('K_PATH_URL', $_SERVER['HTTP_HOST']."/src/Component/pdf/");
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Hodi International');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Kernreactorstraat 1\nNL - 3903 LG Veendendaal");
