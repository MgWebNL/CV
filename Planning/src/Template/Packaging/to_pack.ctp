...
<div class="box box-default">
    ...
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-cog"></i> <?= __('Naar verpakker') ?></h3>
        <div class="pull-right">
            <?php if($adminlogin["rights"] === true || $adminlogin["rights"] != '2'){ ?>
                <a href="#" id="export" onClick="fnExcelReport('table2excel', 'Naar verpakker');" class="btn btn-xs bg-purple">
    ...
    <div class="box-body">
        ...
        <form action="/Packaging/confirmPackagingOrder/" method="post">
            ...
            <div class="pull-right form-inline">
                ...
                <button type="submit" name="submit" value="submitProformaTop" class="btn bg-purple btn-sm">
                    <i class="fa fa-file-pdf-o"></i> <?= __('Maak proforma') ?>
                </button>
            </div>
                                ...
                                <?php foreach($aOrders as $aOrder){ ?>
                                    ...
                                    <?php if($aOrder->HdIntPrplGeneral->priority == $prio){ ?>
                                        <tr class="<?= ($prio == 1) ? 'warning' : '' ?>" data-touch-href="/Order/<?= $aOrder->orderrule_id ?>">
                                            ...
                                            <td><?= $aNapkins[$aOrder->HdIntPrplGeneral->napkin_nrint]->napkin_name ?></td>
